#include "modbus/core/messages/write_single_coil_response.hpp"
...
write_single_coil_response::write_single_coil_response(
...
buffer_iterator
write_single_coil_response::serialize(buffer_iterator it) const {
    *it++ = unit_id;
